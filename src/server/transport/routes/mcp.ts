 ...
 */
/* v8 ignore start - Legacy SSE requires real SSE connections for testing */
...
export function createLegacySseRouter(mcpServerFactory: () => McpServer): Router {
  ...
  const handleLegacySseMessage = async (req: Request, res: Response, endpoint: string) => {
    ...
    /* v8 ignore start - Legacy SSE session handling */
   ...
   */
  /* v8 ignore start - Legacy SSE routes require real SSE transport */
