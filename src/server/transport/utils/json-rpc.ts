...
import { JsonRpcErrorCode, type JsonRpcErrorCodeType } from '../../errors/index.js';
 ...
 */
export function createJsonRpcError(code: JsonRpcErrorCodeType | number, message?: string, id: RequestId | null = null) {
  return {
    jsonrpc: '2.0',
