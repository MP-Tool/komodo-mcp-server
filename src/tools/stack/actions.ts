...
/**
 * Tool to deploy a Komodo-managed Docker Compose stack.
 */
export const deployStackTool: Tool = {
  name: 'komodo_deploy_stack',
  description:
    'Deploy a Komodo-managed Docker Compose stack. This runs `docker compose up -d` based on the stack configuration.',
  schema: z.object({
...
/**
 * Tool to start a Komodo-managed Docker Compose stack.
 */
export const startStackTool: Tool = {
  name: 'komodo_start_stack',
  description:
    'Start a stopped Komodo-managed Docker Compose stack. Runs `docker compose start` to resume stopped containers.',
  schema: z.object({
    stack: z.string().describe('Stack ID or name'),
  }),
  handler: async (args, { client }) => {
...
/**
 * Tool to restart a Komodo-managed Docker Compose stack.
 */
...
/**
 * Tool to pause a Komodo-managed Docker Compose stack.
 */
export const pauseStackTool: Tool = {
  name: 'komodo_pause_stack',
  description:
    'Pause a running Komodo-managed Docker Compose stack. Runs `docker compose pause` to suspend all container processes.',
  schema: z.object({
    stack: z.string().describe('Stack ID or name'),
  }),
  handler: async (args, { client }) => {
...
/**
 * Tool to unpause a Komodo-managed Docker Compose stack.
 */
export const unpauseStackTool: Tool = {
  name: 'komodo_unpause_stack',
  description:
    'Unpause a paused Komodo-managed Docker Compose stack. Runs `docker compose unpause` to resume all container processes.',
  schema: z.object({
    stack: z.string().describe('Stack ID or name'),
  }),
  handler: async (args, { client }) => {
...
/**
 * Tool to stop a Komodo-managed Docker Compose stack.
 */
export const stopStackTool: Tool = {
  name: 'komodo_stop_stack',
  description:
    'Stop a running Komodo-managed Docker Compose stack. Runs `docker compose stop` to stop all containers without removing them.',
  schema: z.object({
    stack: z.string().describe('Stack ID or name'),
  }),
  handler: async (args, { client }) => {
...
/**
 * Tool to destroy a Komodo-managed Docker Compose stack.
 */
export const destroyStackTool: Tool = {
  name: 'komodo_destroy_stack',
  description:
    'Destroy (remove) all containers of a Komodo-managed Docker Compose stack. Runs `docker compose down`. The stack configuration in Komodo is preserved.',
  schema: z.object({
    stack: z.string().describe('Stack ID or name'),
  }),
  handler: async (args, { client }) => {
